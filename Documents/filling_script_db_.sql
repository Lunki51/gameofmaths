...
INSERT INTO CHAPTER VALUES(1,'Geomtrie');
INSERT INTO CHAPTER VALUES(2,'Multiplication');

INSERT INTO QUIZ VALUES(1,1);
INSERT INTO QUIZ VALUES(2,2);

INSERT INTO QUESTION VALUES(1,'Ci dessous un carr','Quelle est la valeur de b ?','/geo/carre1.png','OPEN',1,1);

INSERT INTO QUESTION VALUES(7,'Ci dessous un carr','Quelles affirmations sont vrai?','/geo/carre2.png','QCM',2,1);

INSERT INTO QUESTION VALUES(3,'Combien fait 3*3 ?','','','OPEN',2,2);
INSERT INTO QUESTION VALUES(4,'Combien fait 3*(-1*3) ?','','','OPEN',4,2);

INSERT INTO QUESTION VALUES(5,'2^4 est quivalent  ','','','QCU',6,2);
